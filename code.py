...
class Tetromino(GameObject):
    ...
    def create_sprites(self):
        for block in self.shape:
            sprite = stage.Sprite(self.bank, 1, GRID_SIZE, GRID_SIZE)
...
class TetrisGame:
    ...
    def __init__(self):
        ...
        self.bank = stage.Bank.from_bmp16("/assets/tetris_sprites4.bmp")
        self.bank_background = stage.Bank.from_bmp16("/assets/tetris_background.bmp")

        self.background = stage.Grid(self.bank_background, 10, 8)

        self.stage = stage.Stage(self.display, 60)

        # DO NOT put sprites here
        self.stage.layers = [self.background]
    ...
    def run(self):
        while True:
            ...
            # 1. Draw background
            # self.stage.render_block()

            # 2. Draw sprites separately
            sprite_list = self.locked_blocks + self.current_piece.blocks
            self.stage.render_sprites(sprite_list)
